(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/common'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('gallery-lib', ['exports', '@angular/animations', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['gallery-lib'] = {}),global.ng.animations,global.ng.common,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,animations,common,rxjs,operators,core) { 'use strict';
    ...
    var GalleryService = /** @class */ (function () {
        function GalleryService(config) {
            ...
            this.state = new rxjs.BehaviorSubject(defaultState);
            /** Initialize the config */
            this.config = Object.assign({}, defaultConfig, config);
            /** Initialize the player for play/pause commands */
            this.player = new rxjs.Subject();
            this.player.pipe(operators.switchMap(( /**
             * @param {?} interval
             * @return {?}
             */function (interval) { return (interval) ? _this.playerEngine(interval) : rxjs.of(null); }))).subscribe();
        }
         ...
         */
            function (interval) {
                var _this = this;
                return rxjs.interval(interval).pipe(operators.takeWhile(( /**
                 * @return {?}
                 */function () { return _this.state.getValue().play || false; })), operators.tap(( /**
                 * @return {?}
                 */function () { return _this.next(); })), operators.finalize(( /**
                 * @return {?}
    ...
    var GalleryBulletsComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        GalleryBulletsComponent.ctorParameters = function () {
            return [
                { type: GalleryService },
                { type: core.Renderer2 },
    ...
    /** @type {?} */
    var animation = [
        animations.trigger('imgAnimate', [
            animations.state('fade', animations.style({ opacity: 1 })),
            animations.transition('none => fade', [
                animations.style({
                    opacity: 0
                }),
                animations.animate('0.5s ease-in')
            ])
        ])
    ];
    ...
    var GalleryLoaderComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        GalleryLoaderComponent.ctorParameters = function () {
            return [
                { type: GalleryService }
            ];
        };
    ...
    var GalleryMainComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        GalleryMainComponent.ctorParameters = function () {
            return [
                { type: GalleryService }
            ];
        };
    ...
    var GalleryModalComponent = /** @class */ (function () {
            ...
            { type: core.Component, args: [{
                        ...
                        animations: [
                            animations.trigger('popup', [
                                animations.state('in', animations.style({ opacity: 0.8, transform: 'scale(0.2) translate3d(0, 100px, 0)' })),
                                animations.transition('void => *', [
                                    animations.style({ opacity: 0.8, transform: 'scale(0.2) translate3d(0, 100px, 0)' }),
                                    animations.animate(300)
                                ]),
                                animations.transition('* => void', [
                                    animations.animate(300, animations.style({ opacity: 1, transform: 'scale(1)  translate3d(0, 0, 0)' }))
                                ])
                            ])
                        ],
        ...
        /** @nocollapse */
        GalleryModalComponent.ctorParameters = function () {
            return [
                { type: GalleryService }
            ];
        };
        GalleryModalComponent.propDecorators = {
            ...
            keyboardInput: [{ type: core.HostListener, args: ['body:keydown', ['$event'],] }]
        };
    ...
    var GalleryPlayerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        GalleryPlayerComponent.ctorParameters = function () {
            return [
                { type: GalleryService }
            ];
        };
    ...
    var GalleryTextComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        GalleryTextComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Renderer2 }
            ];
    ...
    var GalleryDirective = /** @class */ (function () {
         ...
         */
            function () {
                 ...
                 */function () {
                    ...
                    _this.srcList = srcs;
                    rxjs.from(imageElements).pipe(operators.map(( /**
                     * @param {?} img
                     * @param {?} i
                     * @return {?}
                     */function (img, i) {
        ...
        /** @nocollapse */
        GalleryDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Renderer2 },
                { type: GalleryService }
    ...
    var LazyDirective = /** @class */ (function () {
        function LazyDirective(el, renderer) {
             ...
             */
            this.lazyWorker = new rxjs.Subject();
            this.lazyLoad = new core.EventEmitter(false);
            // this.lazyTest.switchMap((done) => (done) ? Observable.of(done).delay(1000) : Observable.of(done)
            this.lazyWorker.pipe(operators.switchMap(( /**
             * @param {?} done
             * @return {?}
             */function (done) { return rxjs.of(done); })))
                .subscribe(( /**
         * @param {?} img
         * @return {?}
         */function (img) {
    ...
    var TapDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        TapDirective.ctorParameters = function () {
            return [
                { type: GalleryService },
                { type: core.ElementRef },
                { type: core.Renderer2 }
    ...
    exports.GalleryBulletsComponent = GalleryBulletsComponent;
    exports.animation = animation;
    exports.GalleryImageComponent = GalleryImageComponent;
    exports.GalleryLoaderComponent = GalleryLoaderComponent;
    exports.GalleryMainComponent = GalleryMainComponent;
    exports.GalleryModalComponent = GalleryModalComponent;
    exports.GalleryNavComponent = GalleryNavComponent;
    exports.GalleryPlayerComponent = GalleryPlayerComponent;
    exports.GalleryTextComponent = GalleryTextComponent;
    exports.GalleryThumbComponent = GalleryThumbComponent;
    exports.galleryFactory = galleryFactory;
    exports.CONFIG = CONFIG;
    exports.GalleryModule = GalleryModule;
    exports.GalleryDirective = GalleryDirective;
...
//# sourceMappingURL=gallery-lib.umd.js.map